/* ==========================================================================
   Jeu d'icones SVG inline (remplace lucide-react).
   Traces repris du set Lucide (ISC). Usage : Icons.sun('t-amber', 16)
   ========================================================================== */
(function (global) {
  'use strict';

  // Corps de chaque icone : uniquement le contenu interne du <svg>.
  var PATHS = {
    ...
    batteryCharging: '<path d="M15 7h1a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2h-2M6 7H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h1"/><path d="m11 7-3 5h4l-3 5"/><line x1="22" x2="22" y1="11" y2="13"/>',
    ...
    sparkles: '<path d="M9.94 14.06 12 20l2.06-5.94L20 12l-5.94-2.06L12 4l-2.06 5.94L4 12z"/><path d="M20 3v4M22 5h-4M4 17v2M5 18H3"/>',
  ...
  /**
   * Retourne le markup SVG d'une icone.
   * @param {string} name  cle dans PATHS
   * @param {string} [cls] classes CSS additionnelles
   * @param {number} [size] taille en px (defaut 16)
   */
  function icon(name, cls, size) {
    ...
    var s = size || 16;
    return (
      '<svg class="icon ' + (cls || '') + '" width="' + s + '" height="' + s +
      '" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" ' +
      'stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">' + body + '</svg>'
    );
  }

  // Variante pleine (play / pause) : le trace sert aussi de remplissage.
  function iconFilled(name, cls, size) {
    var body = PATHS[name];
    if (!body) return '';
    var s = size || 16;
    return (
  ...
  global.Icons = { get: icon, filled: iconFilled, names: Object.keys(PATHS) };
})(window);
